      ...
      <div className="min-h-screen bg-stone-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center flex flex-col items-center gap-6 py-20">
          <div className="relative">
            <div className="h-28 w-28 rounded-full bg-emerald-100 flex items-center justify-center text-6xl animate-bounce">
              🐾
            </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-stone-500 leading-relaxed">
              Hemos recibido la información de <strong className="text-stone-700">{petForm.nombre || "tu mascota"}</strong>.
              Nuestro equipo comenzará la búsqueda de inmediato y te contactaremos a{" "}
              <strong className="text-stone-700">{ownerForm.email || "tu correo"}</strong>.
            </p>
          </div>
          <div className="h-px w-full bg-stone-200" />
          <p className="text-sm text-stone-400">
            Si tienes más información, escríbenos a{" "}
            <span className="text-emerald-600 font-semibold">contacto@sanosysalvos.cl</span>
          </p>
          <button
            onClick={() => { setSubmitted(false); setActiveStep(1); }}
            className="rounded-xl bg-emerald-600 px-8 py-3 font-bold text-white hover:bg-emerald-700 transition-colors duration-200 shadow-lg shadow-emerald-200"
          >
            Hacer otro reporte
          </button>
        </div>
      ...
      <nav className="sticky top-0 z-50 border-b border-stone-200 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-full bg-emerald-600 flex items-center justify-center text-white text-lg">
              🐾
            </div>
            <div className="flex flex-col leading-none">
              <span className="font-display text-lg font-black text-stone-800 tracking-tight">
                Sanos y Salvos
              </span>
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-medium text-stone-500">
            ...
            <a
              href="#reporte"
              className="rounded-lg bg-emerald-600 px-4 py-2 text-white font-semibold hover:bg-emerald-700 transition-colors shadow-sm"
            >
              Reportar mascota
            </a>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-lg text-stone-500 leading-relaxed max-w-md">
                En <strong className="text-stone-700">Sanos y Salvos</strong> conectamos dueños
                con sus mascotas perdidas a través de una red de voluntarios, refugios y
                comunidades activas en toda Chile.
              </p>

              <div className="flex flex-wrap gap-3">
                <a
                  href="#reporte"
                  className="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-7 py-4 font-bold text-white shadow-xl shadow-emerald-200 hover:bg-emerald-700 hover:-translate-y-0.5 transition-all duration-200"
                >
                  🔍 Reportar mascota perdida
                </a>
                <a
                  href="#nosotros"
                  className="inline-flex items-center gap-2 rounded-xl border-2 border-stone-200 px-7 py-4 font-bold text-stone-700 hover:border-stone-300 hover:bg-stone-50 transition-all duration-200"
                >
                  Conocer más →
                </a>
              </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-stretch">
            {[
              ...
              <div key={step.n} className="flex-1 relative rounded-2xl bg-white border border-stone-200 p-8 flex flex-col gap-4 shadow-sm">
                <span className="font-display text-5xl font-black text-stone-100 absolute top-4 right-6 select-none">
                  {step.n}
                </span>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-stone-500 leading-relaxed">
                La Fundación <strong className="text-stone-700">Sanos y Salvos</strong> nació en 2018 como
                respuesta a la creciente crisis de mascotas perdidas en Chile. Sabemos lo devastador que
                es perder a un compañero peludo, y por eso pusimos nuestra energía en crear un sistema
                eficiente de búsqueda y reencuentro.
              </p>
              <p className="text-stone-500 leading-relaxed">
                Contamos con una red de más de <strong className="text-stone-700">850 voluntarios</strong> distribuidos
                en todo el país, trabajando de forma coordinada con refugios, veterinarias y municipios
                para encontrar a cada mascota reportada.
              </p>
              <div className="flex flex-wrap gap-3">
                {["🏠 Sin lucro", "🐾 Animales primero", "🌿 100% voluntarios", "📞 Atención 24/7"].map(
                  (tag) => (
                    <span
                      key={tag}
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={item.title}
                  className={`rounded-2xl border ${item.color} p-6 flex flex-col gap-2`}
                >
      ...
      <section id="reporte" className="py-24 bg-stone-50 border-t border-stone-200">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="text-center flex flex-col items-center gap-4 mb-12">
            ...
            <h2 className="font-display text-4xl font-black text-stone-900">
              Reportar mascota perdida
            </h2>
            <p className="text-stone-500 max-w-lg leading-relaxed">
              Completa la información en dos pasos. Cuanta más detalle proporciones, 
              mayor será la probabilidad de reencuentro.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 mb-10 max-w-xs mx-auto">
            {[
              ...
              <>
                ...
                >
                  <span
                    className={`h-6 w-6 rounded-full text-xs flex items-center justify-center font-black ${
                      activeStep === s.n ? "bg-white/20" : "bg-stone-100"
                    }`}
                  >
                    {s.n}
                  </span>
              ...
              <div className="p-8 md:p-10">
                <div className="flex items-center gap-4 mb-8 pb-8 border-b border-stone-100">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-stone-400">
                      Necesitamos estos datos para contactarte con novedades
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-8 flex justify-end">
                  <button
                    ...
                    disabled={!ownerForm.nombre || !ownerForm.telefono || !ownerForm.email || !ownerForm.comuna}
              ...
              <div className="p-8 md:p-10">
                <div className="flex items-center gap-4 mb-8 pb-8 border-b border-stone-100">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-stone-400">
                      Describe con el mayor detalle posible para facilitar la búsqueda
                    </p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    <Field label="Lugar donde se perdió" required>
                      <input
                        name="lugarPerdida"
                        value={petForm.lugarPerdida}
                        onChange={handlePetChange}
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-sm leading-relaxed">
                Conectamos mascotas perdidas con sus familias desde 2018. Una red de amor
                y voluntad en todo Chile.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 text-sm">
                <a href="mailto:contacto@sanosysalvos.cl" className="hover:text-emerald-400 transition-colors">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 text-sm">
                ...
                <a href="#" className="hover:text-emerald-400 transition-colors">Twitter @sanosysalvos</a>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-stone-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-stone-600">
              Hecho con ❤️ por voluntarios para mascotas y sus familias
            </p>
          </div>
        </div>
      </footer>
